...
const ContentHome = () => {
  ...
  return (
    <div className="max-w-sm md:max-w-2xl lg:max-w-[1200px] mx-auto">
      <div className=" max-w-sm lg:max-w-[1200px] mx-auto">
        {openSearch ? (
          <form
            onSubmit={(e) => handleSearch(e)}
            className="flex items-center text-xl mb-12"
          >
          ...
          <div
            ...
            className="flex justify-end text-white hover:cursor-pointer mb-5 "
          >
            <IoSearch size={26} />
          </div>
        )}
